...
public class Principal {
    ...
    public static void buscarJugador() {
        ...
        System.out.println("Ingrese nombre del jugador");
        String nombre = entrada.nextLine();
        LecturaSecuencialJugador lj = new LecturaSecuencialJugador(nombreArchivo);
        lj.establecerRegistroBuscado(nombre);
        Jugador ju = lj.obtenerRegistroBuscado();
        if (ju == null) {
            System.out.println("Jgador no encontrado");
        } else {
